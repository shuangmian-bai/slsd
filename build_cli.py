...
# -*- coding: utf-8 -*-
"""
将Python CLI项目打包成exe文件的脚本（控制台版本）
"""
...
def build_executable():
    ...
    main_script = os.path.join(current_dir, "cli_main.py")
    ...
    cmd.extend([
        ...
        "--hidden-import", "parsers.hnjy_parser",
        "--hidden-import", "parsers.hnedutv_parser",
        main_script
    ])
